            ...
            <div class="panel-body">
              ...
              <div class="form-group row">
                        ...
                        foreach ($setinfo as $taxss) {?>
                          <div class="form-group row"><label for="fieldname" class="col-sm-1 col-form-label"><?php echo display('tax_name')?> <?php echo $i;?>*</label><div class="col-sm-2"><input type="text" class="form-control" name="taxfield[]" required="" value="<?php echo html_escape($taxss['tax_name']);?>"></div>
                      ...
                      <?php $i++;}?>
                        ...
                        <div class="row text-center">
                           <h3> <span class="text-danger"><?php echo display('update_tax_settings')?></span></h3>
                        </div>
                        <?php echo form_close()?>
            </div>
        </div>

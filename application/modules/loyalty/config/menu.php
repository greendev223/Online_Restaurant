...
<li class="treeview active">
                    ...
                    <a href="javascript:void(0)">
                        <i class="fa fa-trophy"></i> <span><?php echo ('Loyalty');?></span>
                    ...
                    <?php if($this->permission->check_label('pointstting')->access()){?>
                     <li class="treeview"><a href="<?php echo base_url('loyalty/loyalty/') ?>"><i class="fa fa-hand-o-right"></i><span><?php echo ('Pointstting');?></span> </a></li>
                     <?php }
					 ...
					 ?>
                     <li class="treeview"><a href="<?php echo base_url('loyalty/loyalty/customerpointlist') ?>"><i class="fa fa-gift"></i> <span><?php echo ('customerpoint list');?></span></a></li>
                     <?php }

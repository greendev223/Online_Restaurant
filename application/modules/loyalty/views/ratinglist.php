...
<?php //echo display('add_rating')?></button> 
<?php //endif; ?>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open_multipart('dloyalty/loyalty/createreview') ?>
						...
						?>
                            ...
                            <?php foreach ($ratinglist as $rating) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                    <?php if($this->permission->method('loyalty','update')->access()): ?>
                                    <input name="url" type="hidden" id="url_<?php echo $rating->ratingid; ?>" value="<?php echo base_url("loyalty/loyalty/updateintratingfrm") ?>" />
                                        <a onclick="editinfo('<?php echo $rating->ratingid; ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                         <?php endif; 
										 if($this->permission->method('loyalty','delete')->access()): ?>
                                        <a href="<?php echo base_url("loyalty/loyalty/deleterating/$rating->ratingid") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
                                         <?php endif; ?>
                                    </td>

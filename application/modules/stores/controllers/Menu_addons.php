...
class Menu_addons extends MX_Controller {
    ...
    public function index()
    {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('stores/menu_addons/index');
	  ...
	  if ($this->form_validation->run()) { 
	   ...
	   'entry_date'          => date('Y-m-d H:i:s'),
		...
		$this->logs_model->log_recorded($logData);
		 ...
		 redirect('stores/menu_addons/create');
		} else {
	   ...
	   'entry_date'          => date('Y-m-d H:i:s'),
		...
		redirect("stores/menu_addons/create/".$postData['add_store_id']);  
	   }
	  } else { 
    ...
    public function delete($addons = null)
    {
	   ...
	   'entry_date'          => date('Y-m-d H:i:s'),
		...
		redirect('stores/menu_addons/index');
    }

				...
				echo form_open_multipart("stores/store/create") ?>
                   ...
                   <?php  echo form_hidden('id',$this->session->userdata('id')); ?>
                    ...
                    <div class="form-group row">
                        <label for="firstname" class="col-sm-4 col-form-label">Restaurant Name*</label>
                        <div class="col-sm-8">
                            <input name="addstoresname" class="form-control" type="text" placeholder="Store Name" id="addstoressname"  value="<?php echo (!empty($addonsinfo->add_store_name)?$addonsinfo->add_store_name:null) ?>">
                        </div>
                    </div>
                     <div class="form-group row">
                        <label for="firstname" class="col-sm-4 col-form-label">Level*</label>
                        <div class="col-sm-8">
                            <input name="addstoresprice" class="form-control" type="text" placeholder="Store Level" id="addstoressprice"  value="<?php echo (!empty($addonsinfo->price)?$addonsinfo->price:null) ?>">
                        </div>
                    </div>
                    </div>
                    <div class="col-lg-6">

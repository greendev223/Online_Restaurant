    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php  
				echo form_open_multipart("store/menu_addons/create") ?>
                   ...
                   <?php  echo form_hidden('id',$this->session->userdata('id')); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="addstorename" class="form-control" type="text" placeholder="Add-ons Name" id="addstorename"  value="<?php echo (!empty($addonsinfo->add_on_name)?$addonsinfo->add_on_name:null) ?>">
                        </div>
                    </div>
                     <div class="form-group row">
                        <label for="firstname" class="col-sm-4 col-form-label">Price *</label>
                        <div class="col-sm-8">
                            <input name="addstoreprice" class="form-control" type="text" placeholder="Add-ons Price" id="addstoreprice"  value="<?php echo (!empty($addonsinfo->price)?$addonsinfo->price:null) ?>">
                        </div>
                    </div>
                    </div>
                    <div class="col-lg-6">

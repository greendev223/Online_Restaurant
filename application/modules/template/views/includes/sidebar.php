<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="ordermanage")?"active":null) ?>">
            <a href="#">
                <i class="fa fa-first-order"></i><span><?php echo display('ordermanage')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url('ordermanage/order/pos_invoice') ?>"><?php echo display('pos_invoice')?></a></li>
                <li><a href="<?php echo base_url('ordermanage/order/orderlist') ?>"><?php echo display('order_list')?></a></li>
				<li><a href="<?php echo base_url('ordermanage/order/pendingorder') ?>"><?php echo display('pending_order')?></a></li>
                <li><a href="<?php echo base_url('ordermanage/order/completelist') ?>"><?php echo display('complete_order')?></a></li>
				<li><a href="<?php echo base_url('ordermanage/order/cancellist') ?>"><?php echo display('cancel_order')?></a></li> 
				<li><a href="<?php echo base_url('ordermanage/order/allkitchen') ?>"><?php echo display('kitchen_dashboard')?></a></li> 
				<li><a href="<?php echo base_url('ordermanage/order/counterdashboard') ?>"><?php echo display('counter_dashboard')?></a></li> 
				<li><a href="<?php echo base_url('ordermanage/order/counterlist') ?>"><?php echo display('counter_list')?></a></li> 
				<li><a href="<?php echo base_url('ordermanage/order/possetting') ?>"><?php echo display('pos_setting')?></a></li>  
				<li><a href="<?php echo base_url('ordermanage/order/soundsetting') ?>"><?php echo display('sound_setting')?></a></li> 
            </ul>
        </li>     
        
		<li class="treeview <?php echo (($this->uri->segment(2)=="reservation")?"active":null) ?>">
            <a href="#">
                <i class="fa fa-tags"></i><span><?php echo display('reservation')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url('reservation/reservation/index') ?>"><?php echo display('reservation')?></a></li>
                <li><a href="<?php echo base_url('reservation/reservation/tablebooking') ?>"><?php echo display('reservation_table')?></a></li>
				<li><a href="<?php echo base_url('reservation/reservation/unavailablelist') ?>"><?php echo display('pending_order')?></a></li>
                <li><a href="<?php echo base_url('reservation/reservation/setting') ?>"><?php echo display('complete_order')?></a></li>
            </ul>
        </li>   

		<li class="treeview <?php echo (($this->uri->segment(2)=="purchase")?"active":null) ?>">
            <a href="#">
                <i class="fa fa-shopping-cart"></i><span><?php echo display('purchase')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url('purchase/purchase/index') ?>"><?php echo display('purchase_item')?></a></li>
                <li><a href="<?php echo base_url('purchase/purchase/create') ?>"><?php echo display('purchase_add')?></a></li>
				<li><a href="<?php echo base_url('purchase/purchase/return_form') ?>"><?php echo display('purchase_return')?></a></li>
                <li><a href="<?php echo base_url('purchase/purchase/return_invoice') ?>"><?php echo display('return_invoice')?></a></li>
				<li><a href="<?php echo base_url('purchase/supplierlist/index') ?>"><?php echo display('supplier_manage')?></a></li>
				<li><a href="<?php echo base_url('purchase/supplierlist/supplier_ledger_report') ?>"><?php echo display('supplier_ledger')?></a></li>
				<li><a href="<?php echo base_url('purchase/purchase/stock_out_ingredients') ?>"><?php echo display('stock_out_ingredients')?></a></li>
            </ul>
        </li>

		<li class="treeview <?php echo (($this->uri->segment(2)=="report")?"active":null) ?>">
            <a href="#">
                <i class="fa fa-line-chart"></i><span><?php echo display('report')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url('report/reports/index') ?>"><?php echo display('purchase_report')?></a></li>
                <li><a href="<?php echo base_url('report/reports/productwise') ?>"><?php echo display('stock_report_product_wise')?></a></li>
				<li><a href="<?php echo base_url('report/reports/ingredientwise') ?>"><?php echo display('purchase_return')?></a></li>
                <li><a href="<?php echo base_url('report/reports/sellrpt') ?>"><?php echo display('purchase_report_ingredient')?></a></li>
				<li><a href="<?php echo base_url('report/reports/sellrptItems') ?>"><?php echo display('sell_report')?></a></li>
				<li><a href="<?php echo base_url('report/reports/servicerpt') ?>"><?php echo display('sell_report_items')?></a></li>
				<li><a href="<?php echo base_url('report/reports/sellrptwaiter') ?>"><?php echo display('scharge_report')?></a></li>
				<li><a href="<?php echo base_url('report/reports/kichansrpt') ?>"><?php echo display('sell_report_waiters')?></a></li>
				<li><a href="<?php echo base_url('report/reports/sellrptdelvirytype') ?>"><?php echo display('kitchen_sell')?></a></li>
				<li><a href="<?php echo base_url('report/reports/sellrptCasher') ?>"><?php echo display('sell_report_delvirytype')?></a></li>
				<li><a href="<?php echo base_url('report/reports/cashregister') ?>"><?php echo display('sell_report_casher')?></a></li>
				<li><a href="<?php echo base_url('report/reports/sellrpt2') ?>"><?php echo display('sell_report_cashregister')?></a></li>
				<li><a href="<?php echo base_url('report/reports/sellrptbydate') ?>"><?php echo display('sell_report_filter')?></a></li>
				<li><a href="<?php echo base_url('report/reports/payroll_commission') ?>"><?php echo display('sele_by_date')?></a></li>
				<li><a href="<?php echo base_url('report/reports/table_sale') ?>"><?php echo display('commission')?></a></li>
            </ul>
        </li>
        <?php }?>
